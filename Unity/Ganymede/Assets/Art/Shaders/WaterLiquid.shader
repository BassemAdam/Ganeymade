Shader "Custom/WaterLiquid"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // The global thickness map generated by WaterThicknessFeature
            ...
            {   
                ...
                // Shallow water: see the refracted scene tinted by shallow color
                // Deep water: scene fades to deep dark color
