Shader "Custom/WaterPhase"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Optional physics-density-grid sampling (enabled at runtime by PhysicsWaterPhaseBridge).
            // Keeping this as a shader_feature avoids forcing extra Vulkan bindings for noise-only materials.
            #pragma shader_feature_local _PHYSICS_DENSITY_GRID
